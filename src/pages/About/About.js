    ...
    <div className="about">
        ...
        <div className="about-text">
            ...
            <div className="about-text-conteiner">
                <p>Підтримати - зробити донат для того, щоб 24-та бригада мала можливість придбати потрібні речі для бійців. Ваші гроші обов’язково допоможуть воїнам бути більш підготовленими та здатними діяти ефективніше.</p>
